...
namespace Pulumi.Azure.Dns {
	...
	/// </summary>
	public class PtrRecord : Pulumi.CustomResource {
		/// <summary>
		/// The name of the DNS PTR Record.
		/// </summary>
		public Pulumi.IO<string> Name { get; set; }
		...
		public PtrRecord(string name, PtrRecordArgs args, Pulumi.ResourceOptions opts = default(Pulumi.ResourceOptions))
			: base("azure:dns/ptrRecord:PtrRecord", name, SerialiseArgs(args), opts) {
		...
		private static Dictionary<string, Pulumi.IO<Google.Protobuf.WellKnownTypes.Value>> SerialiseArgs(PtrRecordArgs args) {
